...
namespace ETModel
{
	[Message(OuterOpcode.C2R_CheckUpdate)]
	public partial class C2R_CheckUpdate : IRequest {}

	[Message(OuterOpcode.R2C_CheckUpdate)]
	public partial class R2C_CheckUpdate : IResponse {}
...
namespace ETModel
{
	...
	{
		 public const ushort C2R_CheckUpdate = 101;
		 public const ushort R2C_CheckUpdate = 102;
